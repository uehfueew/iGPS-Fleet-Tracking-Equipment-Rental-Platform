...
const CompanyProfile = () => {
  ...
  if (loading) {
    return (
      <div className="flex h-full min-h-screen items-center justify-center bg-slate-50 dark:bg-slate-950/80">
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950/80 pb-12 w-full font-sans">
      {/* Clean Professional Header Banner */}
      <div className="bg-white dark:bg-slate-900 px-8 py-8 border-b border-slate-200 shadow-sm">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-5">
            ...
            <div>
              <h1 className="text-2xl font-extrabold text-slate-900 dark:text-slate-300 tracking-tight">Organization Profile</h1>
              <p className="text-slate-500 dark:text-slate-400 mt-1 text-sm font-medium">Configure your platform identity, contact details, and public-facing information.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="px-8 py-8 max-w-5xl mx-auto w-full">
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 overflow-hidden border-t-4 border-t-blue-500">
            <div className="bg-slate-50 dark:bg-slate-950 border-b border-slate-100 px-6 py-4">
                ...
                <div className="md:w-2/3 flex items-center gap-8">
                  <div className="relative group">
                    <div className={cn(
                      ...
                      logoUrl ? "border-slate-200 bg-white dark:bg-slate-900" : "border-dashed border-blue-200 bg-blue-50/50 group-hover:border-blue-400 group-hover:bg-blue-50"
                    )}>
                      {logoUrl ? (
                  ...
                  <div className="flex-1">
                    <h4 className="text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">Upload Guidelines</h4>
                    <ul className="text-xs text-slate-500 dark:text-slate-400 space-y-1.5 list-none">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 overflow-hidden border-t-4 border-t-indigo-500">
            <div className="bg-slate-50 dark:bg-slate-950 border-b border-slate-100 px-6 py-4">
              <h3 className="text-lg font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
              ...
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2 md:col-span-2">
                    <label className="block text-sm font-bold text-slate-700 dark:text-slate-300">Legal Company Name *</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="block w-full pl-11 pr-3 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 rounded-lg focus:bg-white dark:bg-slate-900 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all shadow-sm"
                  ...
                  <div className="space-y-2">
                    <label className="block text-sm font-bold text-slate-700 dark:text-slate-300">Industry / Sector</label>
                    <div className="relative">
                      ...
                      <select
                        ...
                        className="block w-full pl-10 pr-10 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 rounded-lg focus:bg-white dark:bg-slate-900 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all shadow-sm appearance-none"
                      >
                  ...
                  <div className="space-y-2">
                    <label className="block text-sm font-bold text-slate-700 dark:text-slate-300">Tax ID / VAT Number</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="block w-full pl-10 pr-3 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 rounded-lg focus:bg-white dark:bg-slate-900 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all shadow-sm"
                  ...
                  <div className="space-y-2">
                    <label className="block text-sm font-bold text-slate-700 dark:text-slate-300">Year Established</label>
                    <div className="relative">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 overflow-hidden border-t-4 border-t-emerald-500">
             <div className="bg-slate-50 dark:bg-slate-950 border-b border-slate-100 px-6 py-4">
              <h3 className="text-lg font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
             ...
             <div className="p-6 sm:p-8">
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="block text-sm font-bold text-slate-700 dark:text-slate-300">Corporate Phone</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="block w-full pl-11 pr-3 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 rounded-lg focus:bg-white dark:bg-slate-900 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm transition-all shadow-sm"
                  ...
                  <div className="space-y-2 md:col-span-2">
                    <label className="block text-sm font-bold text-slate-700 dark:text-slate-300">Operating Locations</label>
                    <div className="relative">
                  ...
                  <div className="space-y-2 md:col-span-2">
                    <label className="block text-sm font-bold text-slate-700 dark:text-slate-300">Company Bio / Description</label>
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="block w-full pl-11 pr-3 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 rounded-lg focus:bg-white dark:bg-slate-900 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm transition-all resize-none shadow-sm"
          ...
          <div className="flex justify-end gap-3 pt-4">
            <button
              type="button"
              className="px-6 py-2.5 border border-slate-300 rounded-xl shadow-sm text-sm font-bold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:bg-slate-950 transition-all focus:ring-2 focus:ring-slate-200"
            >
              Cancel
            </button>
            <button
